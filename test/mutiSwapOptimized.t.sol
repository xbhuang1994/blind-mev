...
import "../src/mutiSwapOptimized.sol";
...
contract MutiSwapOptimizedTest is Test {
    IUniswapV2Router02 univ2Router =
        IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address wethTokenAddress =
        address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
    MutiSwapOptimized mutiSwapOptimized;
    IWETH WETH = IWETH(wethTokenAddress);

    function setUp() public {
        mutiSwapOptimized = new MutiSwapOptimized();
        vm.deal(address(msg.sender), 1e25);
        WETH.deposit{value: 1e23}();
        WETH.transfer(address(mutiSwapOptimized), 1e23);
    }
    ...
    function test_multiSwapOp() public {
        ...
        (bool s, ) = address(mutiSwapOptimized).call(payload);
        uint256 _after = gasleft();
        assertTrue(s);
        uint balance = IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7).balanceOf(address(mutiSwapOptimized));
